namespace Employee_management_system.Gui.SettingsGui
{
    partial class SettingForm : Form
    {
        ...
        private void SaveGenralSettings()
        {
            ...
            Properties.Settings.Default.NumberOfDataGridViewItems = (int)numericUpDownNoOfItmes.Value;
        ...
        private void GetSettings()
        {
            ...
            numericUpDownNoOfItmes.Value = Properties.Settings.Default.NumberOfDataGridViewItems;
            ...
            numericUpDownDuration.Value = Properties.Settings.Default.NumberOfDataGridViewItems;
        }
