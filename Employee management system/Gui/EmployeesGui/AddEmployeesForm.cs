...
using Employee_management_system.Gui.BookThanksGui;
using Employee_management_system.Gui.EmployeesRecordGui;
...
namespace Employee_management_system.Gui.EmployeesGui
{
    public partial class AddEmployeesForm : Form
    {
        ...
        public AddEmployeesForm(Main main, int id, EmployeesUserControl page)
        {
            ...
            labelEmployeeCurrency.Text = Properties.Settings.Default.Currency;
            SetRoleOfTabs();
            AutoFillData();
            GetSalryRates();
        }
        ...
        private async void Add()
        {
            ...
            Employees employees = new Employees
            {
                ...
                JopTitle = comboBoxJobTitle.Text,
        ...
        private async void SetDataForEdit()
        {
            ...
            if (_employees.Id > 0)
            {
                ...
                comboBoxJobTitle.Text = _employees.JopTitle;
